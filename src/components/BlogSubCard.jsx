    ...
    <>
      <Link to={url}>
        <div className="group lg:grid lg:grid-cols-[35%_65%] lg:gap-5 mb-5 shadow hover:shadow-md transition-all duration-300 hover:-translate-y-1">
          <div className="flex justify-center items-center my-auto max-w-[160px] mx-auto aspect-[4/2.8] lg:w-24 lg:max-w-none xl:w-34 bg-slate-100 rounded-sm overflow-hidden">
            <img
              src={image}
              alt={heading}
              loading="lazy"
